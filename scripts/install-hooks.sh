...
if [[ "${GH_SAFETY_ALREADY_INSTALLED:-}" == "true" ]]; then
  echo "If you want to re-install the bashrc block, remove the existing AI POLICY block from ~/.bashrc and re-run this script."
fi
